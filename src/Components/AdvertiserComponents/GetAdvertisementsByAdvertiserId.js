...
export class GetAdvertisementsByAdvertiserId extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(`advertisers/getall/${id}`);
  ...
  render() {
    ...
    return (
      <div>
        <h3>Get All Advertisements by Advertiser ID</h3>
